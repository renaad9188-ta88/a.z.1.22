      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-8">
        ...
        <div className="space-y-8 text-gray-700">
          <section>
            ...
            <p>
              نحن في منصة ميداء ملتزمون بحماية خصوصية معلوماتك الشخصية. هذه السياسة توضح كيفية جمع واستخدام وحماية معلوماتك عند استخدام خدماتنا.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-none space-y-2 mt-4">
              <li>البريد الإلكتروني: info@maidaa-sa.com</li>
              <li>الهاتف: +966541700017</li>
            </ul>
          </section>
        </div>
